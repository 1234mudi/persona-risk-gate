...
const Dashboard1stLine = () => {
  ...
  const visibleRisks = useMemo(() => {
    ...
    // Deduplicate risks by their orgLevel to prevent showing the same parent multiple times
    ...
    // Deduplicate Level 1 risks by orgLevel.level1
    const uniqueLevel1Map = new Map<string, RiskData>();
    level1Risks.forEach(risk => {
      if (!uniqueLevel1Map.has(risk.orgLevel.level1)) {
        uniqueLevel1Map.set(risk.orgLevel.level1, risk);
      }
    });
    const uniqueLevel1Risks = Array.from(uniqueLevel1Map.values());
    
    // Deduplicate Level 2 risks by orgLevel.level1 + level2 combination
    const uniqueLevel2Map = new Map<string, RiskData>();
    level2Risks.forEach(risk => {
      const key = `${risk.orgLevel.level1}|${risk.orgLevel.level2}`;
      if (!uniqueLevel2Map.has(key)) {
        uniqueLevel2Map.set(key, risk);
      }
    });
    const uniqueLevel2Risks = Array.from(uniqueLevel2Map.values());
    ...
    if (hierarchyViewMode === "level3") {
      ...
      uniqueLevel2Risks.forEach(l2Risk => {
        visible.push(l2Risk);
        if (expandedRows.has(l2Risk.id)) {
          ...
          const childLevel3Risks = level3Risks.filter(l3 => 
            l3.orgLevel.level1 === l2Risk.orgLevel.level1 &&
      ...
      uniqueLevel1Risks.forEach(l1Risk => {
        visible.push(l1Risk);
        if (expandedRows.has(l1Risk.id)) {
          // Only show Level 2 risks that belong to this Level 1 (matching orgLevel.level1)
          const childLevel2Risks = uniqueLevel2Risks.filter(l2 => 
            l2.orgLevel.level1 === l1Risk.orgLevel.level1
          );
...
const initialRiskData1stLine: RiskData[] = [
  ...
  },
  {
    ...
    controlEffectiveness: { label: "Not Assessed", color: "gray" },
    testResults: { label: "Design Effective", sublabel: "Operating Effective" },
    residualRisk: { level: "Low", color: "green" },
  ...
  },
  {
    ...
    controlEffectiveness: { label: "Ineffective", color: "red" },
    testResults: { label: "Design Effective", sublabel: "" },
    residualRisk: { level: "High", color: "red" },
  ...
  // Level 2 risks - children of Level 1 risks
  {
    id: "R-1L-011",
    title: "Credit Scoring Model Accuracy",
    dueDate: "2025-12-12",
    riskLevel: "Level 2",
    parentRisk: "Credit Assessment Process",
    businessUnit: "Retail Banking",
    category: "Operational",
    ...
    sectionCompletion: { inherentRating: 60, controlEffectiveness: 40, residualRating: 20, riskTreatment: 0 },
    inherentRisk: { level: "High", color: "red" },
    inherentTrend: { value: "8%", up: true },
    relatedControls: { id: "Control-111", name: "Model Validation", type: "Automated", nature: "Preventive" },
    controlEffectiveness: { label: "Partially Effective", color: "yellow" },
    testResults: { label: "Design Effective", sublabel: "" },
    residualRisk: { level: "Medium", color: "yellow" },
    residualTrend: { value: "5%", up: false },
  ...
  {
    id: "R-1L-012",
    title: "Credit Limit Override Controls",
    dueDate: "2025-12-14",
    riskLevel: "Level 2",
    parentRisk: "Credit Assessment Process",
    businessUnit: "Retail Banking",
    ...
    inherentRisk: { level: "Medium", color: "yellow" },
    inherentTrend: { value: "4%", up: false },
    relatedControls: { id: "Control-112", name: "Override Approval Workflow", type: "Manual", nature: "Preventive" },
    controlEffectiveness: { label: "Effective", color: "green" },
    testResults: { label: "Operating Effective", sublabel: "Design Effective" },
    residualRisk: { level: "Low", color: "green" },
    residualTrend: { value: "2%", up: false },
  ...
  },
  {
    ...
    dueDate: "2025-12-08",
    riskLevel: "Level 2",
    parentRisk: "Customer Onboarding KYC",
    businessUnit: "Retail Banking",
    category: "Compliance",
    owner: "KYC Specialist",
    assessors: ["Emma White"],
    orgLevel: { level1: "Operational", level2: "Retail Banking", level3: "ATM" },
    assessmentProgress: { assess: "in-progress", reviewChallenge: "not-started", approve: "not-started" },
    sectionCompletion: { inherentRating: 80, controlEffectiveness: 60, residualRating: 40, riskTreatment: 10 },
    inherentRisk: { level: "High", color: "red" },
    inherentTrend: { value: "10%", up: true },
    relatedControls: { id: "Control-113", name: "Document Scanner", type: "Automated", nature: "Preventive" },
    controlEffectiveness: { label: "Partially Effective", color: "yellow" },
    testResults: { label: "Design Effective", sublabel: "" },
    residualRisk: { level: "Medium", color: "yellow" },
  ...
  // Level 3 risks - children of Level 2 risks
  {
    id: "R-1L-014",
    title: "Model Input Data Quality",
    dueDate: "2025-12-10",
    riskLevel: "Level 3",
    parentRisk: "Credit Scoring Model Accuracy",
    businessUnit: "Retail Banking",
    category: "Operational",
    owner: "Data Analyst",
    assessors: ["Sarah Johnson"],
    ...
    inherentRisk: { level: "Medium", color: "yellow" },
    inherentTrend: { value: "3%", up: false },
    relatedControls: { id: "Control-114", name: "Data Validation Rules", type: "Automated", nature: "Preventive" },
    controlEffectiveness: { label: "Not Assessed", color: "gray" },
    testResults: { label: "Not Tested", sublabel: "" },
    residualRisk: { level: "Low", color: "green" },
    residualTrend: { value: "1%", up: false },
    status: "Sent for Assessment",
  ...
  },
  {
    ...
    orgLevel: { level1: "Operational", level2: "Retail Banking", level3: "ATM" },
    assessmentProgress: { assess: "in-progress", reviewChallenge: "not-started", approve: "not-started" },
    sectionCompletion: { inherentRating: 50, controlEffectiveness: 25, residualRating: 0, riskTreatment: 0 },
    inherentRisk: { level: "High", color: "red" },
    inherentTrend: { value: "7%", up: true },
    relatedControls: { id: "Control-115", name: "Performance Dashboard", type: "Automated", nature: "Detective" },
    controlEffectiveness: { label: "Partially Effective", color: "yellow" },
    testResults: { label: "Design Effective", sublabel: "" },
    residualRisk: { level: "Medium", color: "yellow" },
  ...
  {
    id: "R-1L-016",
    title: "ID Document Authenticity Check",
    dueDate: "2025-12-07",
    riskLevel: "Level 3",
    parentRisk: "KYC Document Verification",
    businessUnit: "Retail Banking",
    category: "Compliance",
    owner: "Fraud Prevention Analyst",
    assessors: ["Chris Anderson"],
    orgLevel: { level1: "Operational", level2: "Retail Banking", level3: "ATM" },
    assessmentProgress: { assess: "completed", reviewChallenge: "not-started", approve: "not-started" },
    sectionCompletion: { inherentRating: 100, controlEffectiveness: 80, residualRating: 60, riskTreatment: 40 },
    inherentRisk: { level: "Critical", color: "red" },
    inherentTrend: { value: "12%", up: true },
    relatedControls: { id: "Control-116", name: "ID Verification API", type: "Automated", nature: "Preventive" },
    controlEffectiveness: { label: "Effective", color: "green" },
    testResults: { label: "Operating Effective", sublabel: "Design Effective" },
    residualRisk: { level: "High", color: "red" },
    residualTrend: { value: "8%", up: false },
